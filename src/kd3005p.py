...
if __name__ == "__main__":
    ...
    if True:
        psu = kd3005pInstrument('COM3')
        if psu.isConnected == True:
            print(psu.getIdn())
            psu.setVolt(11.33)
            psu.setAmp(0.1)
            print("Vset=" + str(psu.getVolt()) + "V, Vread=" + str(psu.readVolt()) + "V")
            print("Aset=" + str(psu.getAmp()) + "A, Aread=" + str(psu.readAmp()) + "A")
            print("Status= " + str(psu.status))
        psu.close()	
